...
/* hyperloglog */
DATA(insert OID = 3998 ( hll	PGNSP PGUID	-1 f b U f t \054 0	 0 5000 hll_in   byteaout   hll_recv byteasend hll_typmodin hll_typmodout - i x f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("hyperloglog");
